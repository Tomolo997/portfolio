...
var containerSkills = document.querySelector('.container__skills');
var containerProjects = document.querySelector('.container__Projects');
var containerContact = document.querySelector('.container__contact');
var navigationItemSkills = document.querySelector('.navigationItemSkills');
var navigationItemProjects = document.querySelector('.navigationItemProjects');
var navigationItemContact = document.querySelector('.navigationItemContact');
